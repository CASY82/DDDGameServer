package com.study.futurelab.infrastructure.aop.log;
...
public class ErrorLogDiscordAspect {
    ...
    public void logError(JoinPoint joinPoint, Throwable ex) {
    	AopMessage message = new AopMessage(String.format("[Server Error] Exception in %s.%s() with cause = %s", joinPoint.getSignature().getDeclaringTypeName(),
